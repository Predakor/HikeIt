...
public class GpxPipelineTests {
    ...
    public void Build_ShouldCalculateMaxAndMinElevation(GpxAnalyticData data) {
    ...
    [Theory]
    [MemberData(nameof(GpxTestData.AllTripData), MemberType = typeof(GpxTestData))]
    public void Build_ShouldCalculateTotalAscentAndDescent(GpxAnalyticData data) {
    ...
    [Theory]
    [MemberData(nameof(GpxTestData.AllTripData), MemberType = typeof(GpxTestData))]
    public void Build_ShouldIncludeReachedPeaks(GpxAnalyticData data) {
