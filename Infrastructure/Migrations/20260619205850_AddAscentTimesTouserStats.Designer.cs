...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260619205850_AddAscentTimesTouserStats")]
    partial class AddAscentTimesTouserStats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.AppSettings.Root.AppSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Trips.Analytics.Root.TripAnalytic", b =>
                {
                    ...
                    b.Property<LineString>("VisualisationPath")
            ...
            modelBuilder.Entity("Domain.Users.Stats.UserStats", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<TimeSpan>("TotalClimbDuration")
                        .HasColumnType("interval");

                    b.Property<TimeSpan>("TotalDescentDuration")
                        .HasColumnType("interval");
            ...
            modelBuilder.Entity("Domain.FileReferences.FileReference", b =>
                {
                    b.HasOne("Domain.Trips.Root.Trip", null)
                        .WithOne("GpxFile")
            ...
            modelBuilder.Entity("Domain.Peaks.Peak", b =>
                {
                    b.HasOne("Domain.Locations.Regions.Region", "Region")
                        .WithMany("Peaks")
            ...
            modelBuilder.Entity("Domain.ReachedPeaks.ReachedPeak", b =>
                {
                    ...
                    b.HasOne("Domain.Trips.Root.Trip", "Trip")
                        .WithMany("Peaks")
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Users.Root.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Trips.Analytics.ElevationProfiles.ElevationProfile", b =>
                {
                    b.HasOne("Domain.Trips.Analytics.Root.TripAnalytic", null)
                        .WithOne("ElevationProfile")
                        .HasForeignKey("Domain.Trips.Analytics.ElevationProfiles.ElevationProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("Domain.Common.Geography.ValueObjects.GpxPoint", "Start", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Trips.Analytics.Peaks.PeaksAnalytic", b =>
                {
                    b.HasOne("Domain.Trips.Analytics.Root.TripAnalytic", null)
                        ...
                        .HasForeignKey("Domain.Trips.Analytics.Peaks.PeaksAnalytic", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Domain.Trips.Analytics.Root.TripAnalytic", b =>
                {
                    b.HasOne("Domain.Trips.Root.Trip", null)
                        .WithOne("Analytics")
                        .HasForeignKey("Domain.Trips.Analytics.Root.TripAnalytic", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Domain.Trips.Analytics.Route.RouteAnalytic", "RouteAnalytics", b1 =>
                        {
                    ...
                    b.OwnsOne("Domain.Trips.Analytics.Time.TimeAnalytic", "TimeAnalytics", b1 =>
                        {
                            b1.Property<Guid>("TripAnalyticId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Users.Stats.UserStats", b =>
                {
                    b.HasOne("Domain.Users.Root.User", null)
                        .WithOne("Stats")
                        .HasForeignKey("Domain.Users.Stats.UserStats", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
